...
public class AjaxAuthenticationProvider implements AuthenticationProvider {
    ...
    @Autowired
    public AjaxAuthenticationProvider(final UsuarioService userService, final BCryptPasswordEncoder encoder) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        Usuario user = userService.getByUsername(username, password).orElseThrow(() -> new UsernameNotFoundException("User not found: " + username));
        
        /* RETIRANDO PARA DEIXAR SHA1 por enquanto
